...
| d08 | union-find over star pairs sorted by 3-D distance | `class DSU` with array-backed parent/size tables, `math.sqrt`, sort by tuple field `(a, b) => a.2 < b.2`, recursive method with path-compression write |
